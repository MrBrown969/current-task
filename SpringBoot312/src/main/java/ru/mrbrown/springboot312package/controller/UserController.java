package ru.mrbrown.springboot312package.controller;
...
import ru.mrbrown.springboot312package.service.UserService;
...
public class UserController {
   ...
   @GetMapping ("/")
    ...
    public String updateUser2(Model model, @RequestParam("idToUpdate")int id) {//переименовать в updateUser
    ...
    @PostMapping("/delete")
    public String delete2 (@RequestParam("idToDelete") int id) { //исправить на delete
